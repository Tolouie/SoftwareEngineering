...
public class CreateAccountPanel extends JPanel
{
	  ...
	  private JPasswordField passwordFieldVerification;
	  ...
	  {
	    return new String(passwordFieldVerification.getPassword());
	  }
	  ...
	  public void clearFields() {
		  ...
		  passwordFieldVerification.setText("");
		  errorLabel.setText("");
	  }
	  ...
	  public CreateAccountPanel(CreateAccountControl cc)
	  {
	    ...
	    JLabel passwordVerificationLabel = new JLabel("Verify Password:", JLabel.RIGHT);
	    passwordFieldVerification = new JPasswordField(10);
	    loginPanel.add(usernameLabel);
	    loginPanel.add(usernameField);
	    loginPanel.add(passwordLabel);
	    loginPanel.add(passwordField);
	    loginPanel.add(passwordVerificationLabel);
	    loginPanel.add(passwordFieldVerification);
